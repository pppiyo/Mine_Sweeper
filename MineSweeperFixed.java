...
public class MineSweeperFixed {
   ...
   private static boolean[][] nonRecMineField =
      {{false, false},
       {false, false, true},
       {false, false, false, false},
       {false, true, false, false}};

   private static boolean[][] mediumMineField =
...
//      GameBoardPanel gameBoard =new GameBoardPanel(new VisibleField(new MineField(mediumMineField)));
//      GameBoardPanel gameBoard = new GameBoardPanel(new VisibleField(new MineField(nonRecMineField)));
